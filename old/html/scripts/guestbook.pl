...
$guestbookurl = "https://quicksoapy.nl/commentbox/guestbook.html";
$guestbookreal = "commentbox/guestbook.html";
$guestlog = "commentbox/guestlog.html";
$cgiurl = https://quicksoapy.nl/scripts/guestbook.pl";
